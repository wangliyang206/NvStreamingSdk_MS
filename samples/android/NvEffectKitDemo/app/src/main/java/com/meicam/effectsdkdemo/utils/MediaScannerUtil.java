...
import com.meicam.effectsdkdemo.App;
...
public class MediaScannerUtil {
    ...
    private static MediaScannerConnection mediaScanConn = new MediaScannerConnection(App.getAppContext().getApplicationContext(), client);
