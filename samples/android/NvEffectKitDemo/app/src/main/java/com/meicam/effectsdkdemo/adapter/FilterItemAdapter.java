...
public class FilterItemAdapter extends RecyclerView.Adapter<FilterItemAdapter.ViewHolder> {
    private ArrayList<AssetInfoData> mDataList;
    ...
    public FilterItemAdapter(Context context) {
        ...
        mOptions.placeholder(R.mipmap.default_caption);
    }

    public void setDataList(ArrayList<AssetInfoData> dataList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        AssetInfoData assetInfoData = mDataList.get(position);
        if (assetInfoData == null) {
            return;
        }
        String coverPath = assetInfoData.getDefaultCoverPath( );
