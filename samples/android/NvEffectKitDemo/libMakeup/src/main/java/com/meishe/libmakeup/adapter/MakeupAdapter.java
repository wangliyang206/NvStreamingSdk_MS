package com.meishe.libmakeup.adapter;
...
public class MakeupAdapter extends RecyclerView.Adapter<MakeupAdapter.ViewHolder> {
    ...
    private List<MakeupListData> mDataList;
    ...
    public void setDataList(List<MakeupListData> data, int viewType) {
        this.mDataList = data;
        this.mViewType = viewType;
        notifyDataSetChanged();
    }

    public List<MakeupListData> getDataList() {
        return mDataList;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        MakeupListData item = mDataList.get(position);
        String path = (String) item.getCover();
