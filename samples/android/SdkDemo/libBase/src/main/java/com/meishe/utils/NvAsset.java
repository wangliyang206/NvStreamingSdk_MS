...
public class NvAsset {
    ...
    public static final int ASSET_CHANGE_SPEED_CURVE = 27;  //曲线变速 speed
    public static final int ASSET_ANIMATED_STICKER_IN_ANIMATION = 28;//贴纸进动画 sticker
    public static final int ASSET_ANIMATED_STICKER_OUT_ANIMATION = 29;//贴纸出动画 sticker
    public static final int ASSET_ANIMATED_STICKER_ANIMATION = 30;//贴纸组合动画 sticker
    public static final int ASSET_MAKEUP = 31;//美妆 Makeup
    public static final int ASSET_MAKEUP_WARP = 33;//美妆 Makeup
    public static final int ASSET_MAKEUP_FACE = 34;//美妆 Makeup
    public static final int ASSET_FILTER_DOU = 32;//短视频滤镜 Dou filter
    public static final int ASSET_BEAUTY_TEMPLATE = 33;//美颜模板  beauty template
