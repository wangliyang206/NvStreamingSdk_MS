...
public class NvsTimelineEditor extends RelativeLayout {
    ...
    /**
     * 添加timeSpan add timeline span
     *
     * @param inPoint  inPoint
    ...
    public NvsTimelineTimeSpan addTimeSpan(long inPoint, long outPoint) {
        ...
        if (timelineTimeSpan != null) {
            long minDuaration = 2 * BaseConstants.NS_TIME_BASE;
    ...
    public NvsTimelineTimeSpan addDouVideoTimeSpan(long inPoint, long outPoint) {
        ...
        if (timelineTimeSpan != null) {
            ...
            long minDuaration = 3 * BaseConstants.NS_TIME_BASE;
            long maxDuaration = 15 * BaseConstants.NS_TIME_BASE;
