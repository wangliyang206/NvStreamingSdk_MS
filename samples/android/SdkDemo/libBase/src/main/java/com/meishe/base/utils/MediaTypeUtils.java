...
public class MediaTypeUtils {
    ...
    //text json json文本
    public static final int FILE_TYPE_JSON = 44;
    public static final int FILE_TYPE_TXT = 45;
    private static final int FIRST_TXT_FILE_TYPE = FILE_TYPE_JSON;
    private static final int LAST_TXT_FILE_TYPE = FILE_TYPE_TXT;

    /**
     * The type Media file type.
     * 静态内部类
     */
     ...
     * 添加文件类型
     *
     * @param extension the extension 拓展
     * @param fileType  the file type 文件类型
    ...
    static {
        ...
        addFileType("JSON", FILE_TYPE_JSON, "text/plain");
    ...
    public static boolean isTXTFileType(int fileType) {
        return ((fileType >= FIRST_TXT_FILE_TYPE &&
                fileType <= LAST_TXT_FILE_TYPE));
    }

    /**
     * Is video file type boolean.
     * 视频文件类型
     *
     * @param fileType the file type 文件类型
     * @return the boolean
    ...
    /**
     * Is play list file type boolean.
     * 播放列表文件类型
     *
     * @param fileType the file type 文件类型
     * @return the boolean
     ...
     * @return the file type 文件类型
     */
    public static String getFileTypeBySub(String path) {
        int lastDot = path.lastIndexOf(".");
        if (lastDot < 0)
            return null;
