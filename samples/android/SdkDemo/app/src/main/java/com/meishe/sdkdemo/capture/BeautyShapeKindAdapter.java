...
/**
 * @author jml
 * @des 美型类型选择的适配器 Adapter selected by American type
 */
public class BeautyShapeKindAdapter extends RecyclerView.Adapter<BeautyShapeKindAdapter.ViewHolder> {
    ...
    public interface OnItemClickListener {
        //第一次选中 First selection
        void onItemSelected(BeautyShapeDataKindItem item, int position);
        //第二次选择，此时显示各种调节的特效
        //For the second selection, the special effects of various adjustments will be displayed
