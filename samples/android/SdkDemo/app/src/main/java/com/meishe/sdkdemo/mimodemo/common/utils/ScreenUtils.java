...
public class ScreenUtils {
     ...
     * From dp to px depending on the resolution of the phone
     */
     ...
     * Change from px to dp depending on the resolution of the phone
     */
    ...
    /**
     * 将px值转换为sp值，保证文字大小不变
     * Convert the px value to sp, keeping the text size constant
     */
    ...
    /**
     * 将sp值转换为px值，保证文字大小不变
     * Convert sp to px, keeping the text size constant
     */
    ...
    /**
     * 获取系统栏的高度
     * Gets the height of the system bar
     *
     * @param context
     * @return
     */
    ...
    /**
     * 设置占比屏幕宽度1/4
     * Set the ratio to 1/4 screen width
     *
     * @param context
     * @param view
     */
    ...
    /**
     * 设置占比屏幕宽度16/23
     * Set the ratio screen width 16/23
     *
     * @param context
     * @param view
     */
     ...
     * Gets the original screen size height, including the virtual function key height
     *
     * @param context
     * @return
     */
    ...
    /**
     * 判断手机是否有虚拟按键功能：
     * Determine whether the phone has virtual button function
     *
     * @param activity
     * @return
     */
    ...
    /**
     * 检测虚拟键盘是否开启的
     * Check whether the virtual keyboard is enabled
     *
     * @param windowManager
     * @return
     */
    public static boolean checkDeviceHasNavigationBar(WindowManager windowManager) {
        ...
        display.getMetrics(dm);
        int screenWidth = dm.widthPixels;
        return (creenRealHeight - screenWidth) > 0;
    }
    ...
    /**
     * 检查是否存在虚拟按键栏
     * Check whether a virtual key bar exists
     *
     * @param context
     * @return
     */
    ...
    /**
     * 判断虚拟按键栏是否重写
     * Determines whether the virtual key bar is overwritten
     *
     * @return
     */
