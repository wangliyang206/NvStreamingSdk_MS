...
public class CompoundCaptionOutlineRecyclerAdaper extends RecyclerView.Adapter<CompoundCaptionOutlineRecyclerAdaper.ViewHolder>  {
    private ArrayList<CaptionColorInfo> mCaptionOutlineColorList = new ArrayList<>();
    private Context mContext;
    private OnItemClickListener mOnItemClickListener = null;
    public CompoundCaptionOutlineRecyclerAdaper(Context context) {
        mContext = context;
    }
