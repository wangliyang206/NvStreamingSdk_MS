...
public class MakeCoverFragment extends Fragment {
    ...
    private void initUiListener() {
        ...
        mPlaySeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
                    seekTimeline(progress, NvsStreamingContext.STREAMING_ENGINE_SEEK_FLAG_ALLOW_FAST_SCRUBBING);
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                seekTimeline(seekBar.getProgress(), 0);
    ...
    private void setLiveWindowRatio(int ratio, int titleHeight, int bottomHeight) {
        ...
        int statusHeight = ScreenUtils.getStatusBarHeight(getActivity());//状态栏高度 Status bar height
        int screenWidth = ScreenUtils.getScreenWidth(getActivity());//屏宽 Screen width
        int screenHeight = ScreenUtils.getScreenHeight(getActivity());//屏高 Screen height
