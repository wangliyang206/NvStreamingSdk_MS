...
public class CommonDialog extends Dialog {
    ...
    private void initView() {
        ...
        mOkBtnLayout.setOnClickListener(okClickListener);
        mOkBtn.setOnClickListener(okClickListener);
        ...
        mCancelBtnLayout.setOnClickListener(cancelClickListener);
        mCandelBtn.setOnClickListener(cancelClickListener);
    }
