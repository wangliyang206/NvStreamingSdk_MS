...
public class ImageConverter {
    ...
    /**
     * 把content uri转为 文件路径
     * Convert the content uri to the file path
     *
     * @param contentUri      要转换的content uri The content uri to be converted
     * @param contentResolver 解析器 parser
     * @return
     */
