 ...
 * Add subtitles or added to the mask layer on the NvsMultiThumbnailSequenceView stickers, you can modify the subtitles, or stickers into the point and the point
 */
...
public class NvsTimelineTimeSpan extends RelativeLayout {
    ...
    /**
     * 每秒所显示的像素值
     * The number of pixels displayed per second
     */
