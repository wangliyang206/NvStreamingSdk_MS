...
public class FlipCaptionContentAdapter extends RecyclerView.Adapter<FlipCaptionContentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        boolean isSelectedItem = dataInfo.isSelectItem();
        if (!isSelectedItem) {
    ...
    private void showInputMethod(final ViewHolder holder) {
        ...
        holder.mUserInputText.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                holder.mCaptionInputRect.requestFocus();//获取焦点 Capture focus
                holder.mUserInputText.setSelection(holder.mCaptionContent.getText().length());//将光标设置到最后 Set the cursor to the end
