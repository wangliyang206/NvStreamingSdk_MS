 ...
 */
public class CompoundCaptionBackgroundRecyclerAdaper extends RecyclerView.Adapter<CompoundCaptionBackgroundRecyclerAdaper.ViewHolder>  {
    private ArrayList<CaptionColorInfo> captionBackgroundColorList = new ArrayList<>();
    private Context mContext;
    private OnItemClickListener mOnItemClickListener = null;
    public CompoundCaptionBackgroundRecyclerAdaper(Context context) {
        mContext = context;
    }
