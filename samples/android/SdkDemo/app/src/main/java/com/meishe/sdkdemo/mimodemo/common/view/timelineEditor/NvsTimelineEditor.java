 ...
 * NvsTimelineEditor controls, encapsulation NvsMultiThumbnailSequenceView NvsTimelineTimeSpan. NvsMultiThumbnailSequenceView display video sequence images,
 * can add multiple on NvsMultiThumbnailSequenceView NvsTimelineTimeSpan, convenient to edit stickers with subtitles,
 */
public class NvsTimelineEditor extends RelativeLayout {
    ...
    /**
     * 每微秒显示的像素值
     * Pixel values displayed per microsecond
     */
    public double m_pixelPerMicrosecond = 0D;
    /**
     * 每微秒显示的最大像素值
     * The maximum pixel value displayed per microsecond
     */
    private double m_maxPixelPerMicrosecond = 0D;
    /**
     * 每微秒显示的最小像素值
     * The minimum pixel value displayed per microsecond
     */
    ...
    /**
     * 添加的TimeSpan集合
     * The TimeSpan collection added
     */
    private ArrayList<NvsTimelineTimeSpan> m_timelineTimeSpanArray;
    /**
     * 时间线timeline上的时长
     * timeline Specifies the duration on the timeline
     */
    ...
    /**
     * 初始化TimelineEditor
     * Initializes the TimelineEditor
     */
    public void initTimelineEditor(ArrayList<NvsMultiThumbnailSequenceView.ThumbnailSequenceDesc> sequenceDesc, final long timelineDuration, final long trimInPoint) {
        ...
        //To set the starting position, you need to start from trimInPoint
     ...
     * Add extended timeSpan to fine-tune the time value
     *
     * @param inPoint
     * @param outPoint
     * @return
     ...
     * Zoom in on the MultiThumbnailSequence
     */
     ...
     * Zoom out the MultiThumbnailSequence
     */
    ...
    /**
     * 通过用户选择timeSpan选中
     * Select timeSpan by user selection
     */
    ...
    private void init() {
        ...
        //NvsMultiThumbnailSequenceView放大的m_pixelPerMicrosecond最大值
        //NvsMultiThumbnailSequenceView magnified m_pixelPerMicrosecond maximum
        m_maxPixelPerMicrosecond = m_pixelPerMicrosecond * Math.pow(1.25, 5);
        //NvsMultiThumbnailSequenceView缩小的m_pixelPerMicrosecond最小值
        //NvsMultiThumbnailSequenceView narrow m_pixelPerMicrosecond minimum value
