 ...
 * @Description :MiMoListAdapter。MiMoListAdapter
 * @Copyright :www.meishesdk.com Inc.All rights reserved.
 */
public class MiMoListAdapter extends RecyclerView.Adapter {
    private static final String TAG = "MiMoListAdapter";
    ...
    public MiMoListAdapter(Context context, List<MiMoLocalData> filterList) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnMiMoSelectListener != null) {
                    mOnMiMoSelectListener.onTemplateSelected(position);
                }
            }
        });
        holder.mConfirmView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnMiMoSelectListener != null) {
                    mOnMiMoSelectListener.onTemplateConfirm();
                }
            }
        });
    }
