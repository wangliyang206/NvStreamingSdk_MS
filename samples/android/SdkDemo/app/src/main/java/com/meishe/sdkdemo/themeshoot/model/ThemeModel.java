...
public class ThemeModel implements Serializable {
    ...
    private long endingCaptionDuration;

    public void setEndingCaption(String endingCaption) {
        this.endingCaption = endingCaption;
    }

    public void setEndingCaptionDuration(long endingCaptionDuration) {
        this.endingCaptionDuration = endingCaptionDuration;
    }

    public long getEndingCaptionDuration() {
        return endingCaptionDuration;
    }

    public String getEndingCaption() {
        return endingCaption;
    }
    ...
    public void setLutFilter(String lutFilter) {
