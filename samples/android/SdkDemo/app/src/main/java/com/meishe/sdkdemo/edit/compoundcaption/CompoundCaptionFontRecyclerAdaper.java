...
public class CompoundCaptionFontRecyclerAdaper extends RecyclerView.Adapter<CompoundCaptionFontRecyclerAdaper.ViewHolder> {
    ...
    public CompoundCaptionFontRecyclerAdaper(Context context) {
        mContext = context;
        mOptions.fitCenter();
