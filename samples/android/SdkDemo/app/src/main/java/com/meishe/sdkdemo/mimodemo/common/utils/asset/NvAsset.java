...
public class NvAsset {
    ...
    public static final int DownloadStatusNone = 0;//进入页面的初始状态 The initial state of the page is displayed
    public static final int DownloadStatusPending = 1;//等待状态 Waiting state
    public static final int DownloadStatusInProgress = 2;//下载中 Under download
    public static final int DownloadStatusDecompressing = 3;//安装中 installation
    public static final int DownloadStatusFinished = 4;//下载成功 Download successfully
    public static final int DownloadStatusFailed = 5;//下载失败 Download failure
    public static final int DownloadStatusDecompressingFailed = 6;//安装失败 Installation failure
    ...
    //粒子滤镜类型：触摸 Particle Filter Type: Touch
