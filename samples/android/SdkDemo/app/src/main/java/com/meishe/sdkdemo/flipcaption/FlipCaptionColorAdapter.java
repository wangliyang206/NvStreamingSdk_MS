 ...
 * @Description :翻转字幕颜色Adapter
 * @Description :FlipCaptionColorAdapter
 * @Copyright :www.meishesdk.com Inc.All rights reserved.
 */
public class FlipCaptionColorAdapter extends RecyclerView.Adapter<FlipCaptionColorAdapter.ViewHolder> {
    ...
    public FlipCaptionColorAdapter(Context context) {
        mContext = context;
    }
