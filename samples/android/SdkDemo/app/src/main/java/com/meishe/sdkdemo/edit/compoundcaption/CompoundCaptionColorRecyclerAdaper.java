...
public class CompoundCaptionColorRecyclerAdaper extends RecyclerView.Adapter<CompoundCaptionColorRecyclerAdaper.ViewHolder>  {
    private ArrayList<CaptionColorInfo> mCaptionColorList = new ArrayList<>();
    private Context mContext;
    private OnItemClickListener mOnItemClickListener = null;
    public CompoundCaptionColorRecyclerAdaper(Context context) {
        mContext = context;
    }
