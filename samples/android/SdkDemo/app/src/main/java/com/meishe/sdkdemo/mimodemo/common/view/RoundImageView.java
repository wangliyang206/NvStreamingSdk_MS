...
public class RoundImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.meishe.base.R.styleable.RoundImageView);
            roundWidth = a.getDimensionPixelSize(com.meishe.base.R.styleable.RoundImageView_x_radius, roundWidth);
            roundHeight = a.getDimensionPixelSize(com.meishe.base.R.styleable.RoundImageView_y_radius, roundHeight);
        } else {
