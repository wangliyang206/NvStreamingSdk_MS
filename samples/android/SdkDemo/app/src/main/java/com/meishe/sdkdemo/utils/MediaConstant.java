...
public class MediaConstant {
    ...
    * */
    ...
    public static final String SINGLE_PICTURE_CLICK_TYPE = "pictureClickType";

    public static final String SINGLE_PICTURE_CLICK_CANCEL = "pictureClickCancel";
    public static final String SINGLE_PICTURE_CLICK_CONFIRM = "pictureClickConfirm";
