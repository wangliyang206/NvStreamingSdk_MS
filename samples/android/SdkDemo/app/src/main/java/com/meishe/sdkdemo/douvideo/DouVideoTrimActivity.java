...
public class DouVideoTrimActivity extends BasePermissionActivity {
    ...
    NvsTimelineTimeSpan mDouVideoTimeSpan;
    ...
    private DouVideoTrimHandler mTrimHandler = new DouVideoTrimHandler(this);
    ...
    static class DouVideoTrimHandler extends Handler {
        WeakReference<DouVideoTrimActivity> mWeakReference;

        public DouVideoTrimHandler(DouVideoTrimActivity activity) {
    ...
    protected void initListener() {
        ...
        if (mDouVideoTimeSpan != null) {
            mDouVideoTimeSpan.setOnChangeListener(new NvsTimelineTimeSpan.OnTrimInChangeListener() {
                @Override
            ...
            mDouVideoTimeSpan.setOnChangeListener(new NvsTimelineTimeSpan.OnTrimOutChangeListener() {
                @Override
    ...
    private void initDouVideoSequence() {
        long duration = mTimeline.getDuration();
        ...
        mDouVideoTimeSpan = mTimelineEditor.addDouVideoTimeSpan(mTrimInPoint, mTrimOutPoint);
