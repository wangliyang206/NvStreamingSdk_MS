...
public class NvAsset {
    ...
    public static final int ASSET_CHANGE_SPEED_CURVE = 27;//曲线变速 Curve speed change
    public static final int ASSET_ANIMATED_STICKER_IN_ANIMATION = 28;//贴纸进动画 Sticker animation
    public static final int ASSET_ANIMATED_STICKER_OUT_ANIMATION = 29;//贴纸出动画 Sticker animation
    public static final int ASSET_ANIMATED_STICKER_ANIMATION = 30;//贴纸组合动画 Sticker combination animation
    public static final int ASSET_MAKEUP = 31;//美妆 Beauty makeup
    public static final int ASSET_MAKEUP_WARP = 33;//美妆 Beauty makeup
    public static final int ASSET_MAKEUP_FACE = 34;//美妆 Beauty makeup
    public static final int ASSET_FILTER_DOU = 32;//短视频滤镜 dou video filter
    public static final int ASSET_ARSCENE_PARTICLE = 35;
    ...
    /**
     * 动画子分类id
     * id of the animation subcategory
     */
    ...
    /**
     * 是否通用 1:通用   2.非通用
     * Universal 1: Universal 2. Not universal
     */
