...
public class MediaData {
    ...
    /**
     * 记录点击时显示的大小的位置
     * Record the position of the size displayed when clicked
     */
     ...
     * The difference between a picture and a video is that there is no duration
     *
     * @param thumbPathUri 该字段主要是为了在Andoird Q使用,在其以下为空
     *                     This field is primarily intended for use in Andoird Q and is null below it
     */
