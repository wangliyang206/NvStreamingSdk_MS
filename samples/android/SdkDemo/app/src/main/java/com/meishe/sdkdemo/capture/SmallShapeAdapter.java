...
public class SmallShapeAdapter extends RecyclerView.Adapter<SmallShapeAdapter.ViewHolder> {
...
//    public static final int POS_BEAUTY_ADJUST_COLOR = 5;
    ...
    public SmallShapeAdapter(Context context, List<IFxInfo> dataList) {
        mContext = context;
        mDataList = dataList;
    }
...
//                holder.shape_icon_layout.setBackgroundResource(R.drawable.shape_beauty_menu_select);
            ...
            if (mIsEnable && mSelectedPos == position) {
                if (isConflict && "shape".equals(item.getType())) {
