...
public class SingleClipFragment extends Fragment {
     ...
     * The player progress seek callback is currently used for variable speed pages
     */
    ...
    private void setLiveWindowRatio(int ratio, int titleHeight, int bottomHeight) {
        ...
        int newHeight = screenHeight - titleHeight - bottomHeight;
        switch (ratio) {
    ...
    private void controllerOperation() {
        ...
        mPlaySeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
                    seekTimeline(progress * BASE_VALUE, NvsStreamingContext.STREAMING_ENGINE_SEEK_FLAG_ALLOW_FAST_SCRUBBING);
